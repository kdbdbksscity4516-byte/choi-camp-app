...
try:
    ...
    if not day_df.empty:
        ...
        for t in times:
            ...
            group['prio'] = group.apply(get_prio, axis=1)
        ...
        attended_df = display_df[display_df['참석여부'] == '참석'].sort_values('참석시간_dt')
        pending_df = display_df[display_df['참석여부'] == '미체크']
        map_df = pd.concat([attended_df, pending_df])
